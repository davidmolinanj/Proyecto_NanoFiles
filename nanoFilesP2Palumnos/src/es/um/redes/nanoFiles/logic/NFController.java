...
public class NFController {
	 ...
	 * 
	 */
	private static final byte PINGED_DIRECTORY = 1;
	...
	public void processCommand() {
		...
		case NFCommands.COM_SERVE:
			 ...
			 * servidor de ficheros en el directorio, indicando el uerto en el que nuestro
	...
	//COMANDOS SIEMPRE PERMITIDOS:
		...
		case NFCommands.COM_MYFILES:
			//siempre puedes mirar tu propia carpeta.
		case NFCommands.COM_NICK: 
			//NICK siempre se podrá hacer, aunque
			//cuando el cliente esté sirviendo, enviará
			//un mensaje de error al cliente.
		case NFCommands.COM_HELP:
			//siempre puedes ejecutar HELP.
		case NFCommands.COM_QUIT:
			//realisticamente, seas servidor o no,
			//puedes hacer quit cuando quieras
			//para detener la ejecución.
		case NFCommands.COM_PING:
			//siempre puedes hacer ping.
			commandAllowed = true;
			break;
	...
	//COMANDOS POST-PING:
		...
		case NFCommands.COM_SERVE:
			...
			if (currentState == PINGED_DIRECTORY) {
				commandAllowed = true;
			} else {
				System.err.println("* Debes comunicarte a través del comando 'ping' al directorio antes de usar comandos de red.");
			}
			break;
	...
	private void updateCurrentState(boolean success) {
		...
		default:
			// ningún otro comando cambia el estado
			break;
		}
	}
